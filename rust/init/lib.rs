...
///
/// Use `kernel::macros::pinned_drop` to implement this trait safely:
///
/// ```rust
...
/// # Safety
///
/// This trait must be implemented via the `kernel::macros::pinned_drop` proc-macro attribute on the impl.
